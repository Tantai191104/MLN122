...
export default function Register() {
    ...
    return (
        <div className="min-h-screen flex animate-in fade-in duration-500">
            {/* Left Side - Banner */}
            <div className="hidden lg:flex w-1/2 relative overflow-hidden animate-in slide-in-from-left duration-700">
                {/* Background Image */}
                <img
                    src="https://i.pinimg.com/736x/5c/9d/f8/5c9df8e3c87019ce62a6bcfc32505554.jpg" // <== Thay bằng đường dẫn hình của bạn
                    alt="Register Banner"
                ...
                <div className="relative z-10 max-w-lg text-white p-12 space-y-8">
                    <div>
                        <h2 className="text-4xl font-bold mb-4">Tham gia cộng đồng MLN122</h2>
                        <p className="text-white/90 text-lg leading-relaxed">
                            Kết nối với hàng ngàn độc giả quan tâm đến kinh tế Việt Nam
                        </p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm rounded-xl p-4 hover:bg-white/15 transition-all">
                            ...
                            <div>
                                <h3 className="font-semibold text-lg mb-1">Thông báo thời gian thực</h3>
                                <p className="text-white/80 text-sm">Cập nhật tin tức quan trọng ngay lập tức</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Right Side - Form */}
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background relative overflow-hidden animate-in slide-in-from-right duration-700">
                {/* Background Pattern */}
                ...
                <div className="w-full max-w-md space-y-8 relative z-10">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-muted-foreground">Đăng ký để bắt đầu theo dõi tin tức kinh tế</p>
                    </div>
